...
$DESTINATION_FOLDER = "../../../../images/categories/";
...
$responseMessage = array(
"message"=>"Unable to upload image, your image does not meet the requirements of 700x700 pixels, your image is ".$width."x".$height." pixels",
"status"=>"failed"
);      
...
if($uploader->cutPaste($TEMP_FOLDER.$final_file_name, $DESTINATION_FOLDER)){
    ...
    $responseMessage = array(
        ...
        "image"=>$config->CATEGORY_THUMBNAILS_LINK.$final_file_name,
        "message"=>"",
        "type"=>"product",
        "status"=>"success"); 

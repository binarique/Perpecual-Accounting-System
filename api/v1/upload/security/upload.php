...
$DESTINATION_FOLDER = $config->SECURITY_UPLOAD_FOLDER;
...
$responseMessage = array(
"message"=>"Unable to upload image, Image is too small, your image is ".$width."x".$height." pixels",
"status"=>"failed"
);      
...
if($uploader->cutPaste($TEMP_FOLDER.$final_file_name, $DESTINATION_FOLDER)){
    ...
    $responseMessage = array(
        ...
        "image"=>$helper->getHostURL().$config->SECURITY_FOLDER.$final_file_name,
        "message"=> "",
        "type"=> "id",
        "status"=>"success"); 
